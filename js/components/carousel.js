(function(factory) {
    ...
    carousel.prototype.getSlideCount = function() {
    ...
    carousel.prototype.initializeEvents = function() {
        ...
        if(_.options.focusOnSelect === true) {
            $(_.options.slide, _.$slideTrack).on('click.carousel', _.selectHandler);
        }
    ...
    carousel.prototype.selectHandler = function(event) {
        ...
        var _ = this;
        var index = parseInt($(event.target).parents('.carousel-slide').attr("data-carousel-index"));
        if(!index) index = 0;
